        ...
        >
          ...
          <Routes>
            ...
            <Route
              path="/Laboratory"
              element={
                <Layout currentPageName="Laboratory">
                  <Laboratory />
                </Layout>
              }
            />
            ...
            <Route
              path="/Simulator"
              element={
                <Layout currentPageName="Simulator">
                  <Simulator />
                </Layout>
              }
            />
            ...
            <Route
              ...
              element={
                <Layout currentPageName="StudentAssignments">
                  <StudentAssignments />
                </Layout>
              }
            />
            ...
            <Route
              ...
              element={
                <Layout currentPageName="TemplateBuilder">
                  <TemplateBuilder />
                </Layout>
              }
            />
            ...
            <Route
              path="/RoleSelect"
              element={
                <Layout currentPageName="RoleSelect">
                  <RoleSelect />
                </Layout>
              }
            />
            ...
            <Route
              path="/ConnectTeacher"
              element={
                <Layout currentPageName="ConnectTeacher">
                  <ConnectTeacher />
                </Layout>
              }
            />
